...
const typeColorMap: Record<string, string> = {
  ...
  "恶": "bg-red-50 dark:bg-red-955/10 text-red-200 dark:text-red-300 border-red-200 dark:border-red-900/30",
  "普通": "bg-slate-50 dark:bg-slate-850 text-slate-655 dark:text-slate-300 border-slate-200 dark:border-slate-700",
  ...
  "电": "bg-yellow-50 dark:bg-yellow-955/10 text-yellow-505 dark:text-yellow-400 border-yellow-200 dark:border-yellow-900/30",
  ...
  "虫": "bg-lime-50 dark:bg-lime-955/20 text-lime-655 dark:text-lime-300 border-lime-200 dark:border-lime-900/30",
    ...
    >
      ...
      <div className="w-full sm:col-span-4 flex flex-row sm:flex-col items-center sm:border-r sm:border-slate-100 dark:sm:border-slate-800 pr-0 sm:pr-2 relative min-h-0 gap-3 sm:gap-1.5">
        ...
        <div className="absolute top-1.5 right-1.5 sm:static flex sm:items-center sm:justify-between w-auto sm:w-full gap-1 sm:pb-1.5 shrink-0 z-20">
          ...
          <button
            ...
            className="text-slate-350 dark:text-slate-500 hover:text-rose-600 dark:hover:text-rose-455 hover:bg-rose-50 dark:hover:bg-rose-950/35 p-1 sm:p-0.5 rounded transition-all cursor-pointer border border-transparent hover:border-rose-100 dark:hover:border-rose-900/30 action-buttons"
            title="删除该蛋窝"
          >
      ...
      <div className="w-full sm:col-span-8 flex flex-col justify-start gap-1 border-t sm:border-t-0 border-slate-100 pt-2.5 sm:pt-0">
        ...
        <div className="flex justify-center shrink-0">
          {pet.hideStats ? (
            <div className="w-full py-1.5 px-2 border border-dashed border-slate-200 dark:border-slate-750 rounded-lg bg-slate-50/50 dark:bg-slate-900/40 flex flex-col items-center justify-center select-none">
              <span className="text-[10px] text-slate-555 dark:text-slate-400 font-bold flex items-center gap-1">
        ...
        <div className="flex flex-col gap-1.5 border-t border-slate-100 dark:border-slate-800 pt-2 shrink-0">
          {/* Egg Groups Row */}
          <div className="flex items-center justify-between gap-1.5 bg-slate-50/70 dark:bg-slate-900/40 p-1.5 rounded-lg border border-slate-100/60 dark:border-slate-800">
            <span className="text-[10px] font-bold text-teal-700 dark:text-teal-300 bg-teal-50 dark:bg-teal-950/30 border border-teal-200/50 dark:border-teal-900/40 px-1.5 py-0.5 rounded-md select-none shrink-0 flex items-center gap-0.5">
              宠物蛋组
            </span>
          ...
          <div className="grid grid-cols-12 gap-1 bg-slate-50/70 dark:bg-slate-900/40 p-1.5 rounded-lg border border-slate-100/60 dark:border-slate-800">
            ...
            <div className="col-span-3 flex flex-col gap-0.5">
              ...
              <select
                ...
                className={`appearance-none text-xs font-bold text-center border rounded-md py-0.5 px-0.5 w-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-250 dark:focus:ring-indigo-950 transition-colors ${getBrandStyle(
                  pet.brand
                )}`}
              >
            ...
            <div className="col-span-4 flex flex-col gap-0.5">
              ...
              <select
                ...
                className={`appearance-none text-xs font-bold text-center border rounded-md py-0.5 px-0.5 w-full cursor-pointer focus:outline-none focus:ring-2 transition-colors ${pet.isLimit === "有极限蛋"
                  ...
                  : "bg-slate-105 border-slate-205 text-slate-650 font-medium dark:bg-slate-800 dark:border-slate-700 dark:text-slate-350"
                  }`}
              >
          ...
          {pet.status === "有现蛋" ? (
            ...
            (() => {
              ...
              if (pet.status === "正在孵，可预约") {
                ...
                textClass = "text-sky-850 dark:text-sky-300";
                ...
                statusTextClass = "text-orange-700 dark:text-orange-355 bg-orange-100/80 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-900/40";
                statusLabel = "已撤窝";
                desc = "当前蛋窝精灵蛋已撤窝";
                ...
                statusTextClass = "text-purple-700 dark:text-purple-350 bg-purple-100/80 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-900/40";
                statusLabel = "接投资";
                desc = "空位引资，等待老板投资";
                isPing = true;
              } else {
                ...
                textClass = "text-indigo-850 dark:text-indigo-300";
                statusTextClass = "text-indigo-650 dark:text-indigo-350 bg-indigo-100/60 dark:bg-indigo-950/30 border border-transparent dark:border-indigo-900/30";
              }
